...
const DEFAULT_TABS = [{ value: "all", label: "All" }, { value: "gainers", label: "Top Gainers" }, { value: "losers", label: "Top Losers" }, { value: "trending", label: "Trending", disabled: true }, { value: "categories", label: "Categories", disabled: true }];
